...
function login(username,password){
  ...
  for(var ac in listAccount){
    if( listAccount[ac].username==username){
          if(listAccount[ac].password==password){
            localStorage.setItem("loggedUser",JSON.stringify(listAccount[ac]));
